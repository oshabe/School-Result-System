<x-base-layout>
    ...
    <body data-kt-name="metronic" id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-toolbar-fixed="true" class="app-default">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="kt_user_view_overview_tab" role="tabpanel">
                                        ...
                                        <div class="card card-flush mb-6 mb-xl-9">
                                            ...
                                            <div class="card-header border-0 pt-5">
                                                ...
                                                <div class="card-toolbar">
                                                    <div class="btn btn-sm btn-light-primary" id="print_firstterm_id" style="cursor:pointer">
                                                        <span class="">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach($firstResults as $result)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="text-muted fw-semibold text-muted d-block fs-7 me-2">{{$result->marks}}</span>
                                                                            @unless(auth()->check() && (auth()->user()->status === 'Teacher' || auth()->user()->status === 'Student'))
                                                                                <span class=" text-light text-hover-primary fs-7 edit_single_results" data-result-name="{{$result->marks}}" data-result-id="{{ $result->id }}" style="cursor:pointer" data-bs-toggle="tooltip" title="Edit Result"><i class="las la-pencil-alt"></i></span>
                                                                            @endunless 
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="text-muted fw-semibold text-muted d-block fs-7 me-2">
                                                                                @php
                                                                                    $fendMarks = null;
                                                                                    $fendid = null;
                                                                                @endphp
                                                                            ...
                                                                            @unless(auth()->check() && (auth()->user()->status === 'Teacher' || auth()->user()->status === 'Student'))
                                                                                <span class=" text-light text-hover-primary fs-7 edit_single_end_results" data-end-id="{{$fendid}}" data-end-name="{{$fendMarks}}" style="cursor:pointer" data-bs-toggle="tooltip" title="Edit Result"><i class="las la-pencil-alt"></i></span>
                                                                            @endunless                                                                           
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @php
                                                                            $ftotal = round($fendMarks * 0.8 + $result->marks * 0.2);
                                                                            $ftotalSum += $ftotal;
                                                                        @endphp
                                                                    </td>
                                                                    <td>
                                        ...
                                        <div class="row row-cols-1 row-cols-md-2 mb-6 mb-xl-9">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="fw-bold fs-4">
                                                            <div class="d-flex">
                                                                ...
                                                                <!--end::Svg Icon-->
                                                                @php
                                                                    $faverage = ($fcount > 0) ? $ftotalSum / $fcount : 0;
                                                                    $firstAverage = round($faverage);
                                                                    // Convert faverage to "out of 3" scale
                                                                    if ($firstAverage >= 0 && $firstAverage <= 9) {
                                                                        $outOfThree = '0.0';
                                                                    } elseif ($firstAverage >= 10 && $firstAverage <= 19) {
                                                                        $outOfThree = '0.1';
                                                                    } elseif ($firstAverage >= 20 && $firstAverage <= 29) {
                                                                        $outOfThree = '0.2';
                                                                    } elseif ($firstAverage >= 30 && $firstAverage <= 39) {
                                                                        $outOfThree = '1.3';
                                                                    } elseif ($firstAverage >= 40 && $firstAverage <= 49) {
                                                                        $outOfThree = '1.6';
                                                                    } elseif ($firstAverage >= 50 && $firstAverage <= 59) {
                                                                        $outOfThree = '1.5';
                                                                    } elseif ($firstAverage >= 60 && $firstAverage <= 64) {
                                                                        $outOfThree = '1.6';
                                                                    } elseif ($firstAverage >= 65 && $firstAverage <= 69) {
                                                                        $outOfThree = '1.8';
                                                                    } elseif ($firstAverage >= 70 && $firstAverage <= 79) {
                                                                        $outOfThree = '2.2';
                                                                    } elseif ($firstAverage >= 80 && $firstAverage <= 85) {
                                                                        $outOfThree = '2.4';
                                                                    } elseif ($firstAverage >= 86 && $firstAverage <= 90) {
                                                                        $outOfThree = '2.6';
                                                                    } elseif ($firstAverage >= 91 && $firstAverage <= 95) {
                                                                        $outOfThree = '2.8';
                                                                    } elseif ($firstAverage >= 96 && $firstAverage <= 100) {
                                                                        $outOfThree = '3.0';
                                                                    } else {
                                                                        $outOfThree = 'N/A';
                                                                    }
                                                                @endphp
                                                                <div class="ms-2 "> Average Score = <span class="text-muted fs-6 fw-bold">{{ $faverage }}</span></div>
                                                            </div>
                                                            <div class="fs-7 fw-normal text-muted">An average test score is the sum of all the scores on an assessment divided by the number of test-takers. </div>
                                                        </div>
                                                    </div>
                                                    <!--end::Card body-->
                                                </div>
                                            ...
                                            <div class="col">
                                                <!--begin::Reward Tier-->
                                                <a href="#" class="card hoverable h-md-100" style="background-color: #080655;">
                                                <!--begin::Card body-->
                                                    <div class="card-body p-3">
                                                        <div class="fw-bold fs-4">
                                                            <div class="d-flex">
                                                                ...
                                                                <!--end::Svg Icon-->
                                                                <div class="ms-2 "> Out of 3 = <span class="text-muted fs-6 fw-bold">{{ $outOfThree }}</span></div>
                                                            </div>
                                                            <div class="fs-7 fw-normal text-muted">The average score is calculated based on the total scores, and the <span class="fw-bold"> Out of 3 Scale</span> variable will hold the converted score on the "out of 3" scale</div>
                                                        </div>
                                                    </div>
                                                    <!--end::Card body-->
                                                </a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            ...
                                                                            @unless(auth()->check() && (auth()->user()->status === 'Teacher' || auth()->user()->status === 'Student'))
                                                                                <span class=" text-light text-hover-primary fs-7 edit_single_end_results" data-end-id="{{$sendid}}" data-end-name="{{$sendMarks}}" style="cursor:pointer" data-bs-toggle="tooltip" title="Edit Result"><i class="las la-pencil-alt"></i></span>
                                                                            @endunless 
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @php
                                                                            $stotal = round($sendMarks * 0.8 + $result->marks * 0.2);
                                                                            $stotalSum += $stotal;
                                                                        @endphp
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="fw-bold fs-4">
                                                            <div class="flex">
                                                                <!--begin::Svg Icon | path: icons/duotune/general/gen030.svg-->
                                                                @php
                                                                    $saverage = ($scount > 0) ? $stotalSum / $scount : 0;
                                                                    // Convert saverage to "out of 3" scale
                                                                    $secondAverage = ($saverage + $faverage) / 2;
                                                                    $secondOutOfThree = round($secondAverage);
                                                                    if ($secondOutOfThree >= 0 && $secondOutOfThree <= 9) {
                                                                        $soutOfThree = '0.0';
                                                                    } elseif ($secondOutOfThree >= 10 && $secondOutOfThree <= 19) {
                                                                        $soutOfThree = '0.1';
                                                                    } elseif ($secondOutOfThree >= 20 && $secondOutOfThree <= 29) {
                                                                        $soutOfThree = '0.2';
                                                                    } elseif ($secondOutOfThree >= 30 && $secondOutOfThree <= 39) {
                                                                        $soutOfThree = '1.3';
                                                                    } elseif ($secondOutOfThree >= 40 && $secondOutOfThree <= 49) {
                                                                        $soutOfThree = '1.6';
                                                                    } elseif ($secondOutOfThree >= 50 && $secondOutOfThree <= 59) {
                                                                        $soutOfThree = '1.5';
                                                                    } elseif ($secondOutOfThree >= 60 && $secondOutOfThree <= 64) {
                                                                        $soutOfThree = '1.6';
                                                                    } elseif ($secondOutOfThree >= 65 && $secondOutOfThree <= 69) {
                                                                        $soutOfThree = '1.8';
                                                                    } elseif ($secondOutOfThree >= 70 && $secondOutOfThree <= 79) {
                                                                        $soutOfThree = '2.2';
                                                                    } elseif ($secondOutOfThree >= 80 && $secondOutOfThree <= 85) {
                                                                        $soutOfThree = '2.4';
                                                                    } elseif ($secondOutOfThree >= 86 && $secondOutOfThree <= 90) {
                                                                        $soutOfThree = '2.6';
                                                                    } elseif ($secondOutOfThree >= 91 && $secondOutOfThree <= 95) {
                                                                        $soutOfThree = '2.8';
                                                                    } elseif ($secondOutOfThree >= 96 && $secondOutOfThree <= 100) {
                                                                        $soutOfThree = '3.0';
                                                                    } else {
                                                                        $soutOfThree = 'N/A';
                                                                    }
                                                                ...
                                                                <div class="d-flex justify-content-between"> 
                                                                    <span>Second Term Average Score</span> 
                                                                    <span>-></span>
                                                                    <span class="text-muted fs-6 fw-bold mb-5">{{ $saverage }}</span>
                                                                </div>
                                                                <span class="separator separator-dashed mb-5"></span>
                                                                <div class="d-flex justify-content-between">
                                                                    <span>Cumulative Average Score</span>
                                                                    <span>-></span>
                                                                    <span class="text-muted fs-6 fw-bold">{{ $secondAverage }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body p-3">
                                                        <div class="fw-bold fs-4">
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="ms-2 ">Cumulative ( Out of 3 ) = <span class="text-muted fs-6 fw-bold">{{$soutOfThree}}</span></div>
                                                            </div>
                                                            <div class="fs-7 fw-normal text-muted">The average score is calculated based on the total scores, and the <span class="fw-bold"> Out of 3 Scale </span> variable will hold the converted score on the "out of 3" scale</div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            ...
                                                                            @unless(auth()->check() && (auth()->user()->status === 'Teacher' || auth()->user()->status === 'Student'))
                                                                                <span class=" text-light text-hover-primary fs-7 edit_single_end_results" data-end-id="{{$tendid}}" data-end-name="{{$tendMarks}}" style="cursor:pointer" data-bs-toggle="tooltip" title="Edit Result"><i class="las la-pencil-alt"></i></span>
                                                                            @endunless
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @php
                                                                            $ttotal = round($tendMarks * 0.8 + $result->marks * 0.2);
                                                                            $ttotalSum += $ttotal;
                                                                        @endphp
                                                                    </td>
                                                                    <td>
                                                ...
                                                <div class="card pt-4 h-md-100 mb-6 mb-md-0">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="fw-bold fs-4">
                                                            <div class="flex">
                                                                @php
                                                                    $taverage = ($tcount > 0) ? $ttotalSum / $tcount : 0;
                                                                    $thirdAverage = ($taverage + $secondAverage) / 2;
                                                                    $thirdOutOfThree = round($thirdAverage);
                                                                    // Convert taverage to "out of 3" scale
                                                                    if ($thirdOutOfThree >= 0 && $thirdOutOfThree <= 9) {
                                                                        $toutOfThree = '0.0';
                                                                    } elseif ($thirdOutOfThree >= 10 && $thirdOutOfThree <= 19) {
                                                                        $toutOfThree = '0.1';
                                                                    } elseif ($thirdOutOfThree >= 20 && $thirdOutOfThree <= 29) {
                                                                        $toutOfThree = '0.2';
                                                                    } elseif ($thirdOutOfThree >= 30 && $thirdOutOfThree <= 39) {
                                                                        $toutOfThree = '1.3';
                                                                    } elseif ($thirdOutOfThree >= 40 && $thirdOutOfThree <= 49) {
                                                                        $toutOfThree = '1.6';
                                                                    } elseif ($thirdOutOfThree >= 50 && $thirdOutOfThree <= 59) {
                                                                        $toutOfThree = '1.5';
                                                                    } elseif ($thirdOutOfThree >= 60 && $thirdOutOfThree <= 64) {
                                                                        $toutOfThree = '1.6';
                                                                    } elseif ($thirdOutOfThree >= 65 && $thirdOutOfThree <= 69) {
                                                                        $toutOfThree = '1.8';
                                                                    } elseif ($thirdOutOfThree >= 70 && $thirdOutOfThree <= 79) {
                                                                        $toutOfThree = '2.2';
                                                                    } elseif ($thirdOutOfThree >= 80 && $thirdOutOfThree <= 85) {
                                                                        $toutOfThree = '2.4';
                                                                    } elseif ($thirdOutOfThree >= 86 && $thirdOutOfThree <= 90) {
                                                                        $toutOfThree = '2.6';
                                                                    } elseif ($thirdOutOfThree >= 91 && $thirdOutOfThree <= 95) {
                                                                        $toutOfThree = '2.8';
                                                                    } elseif ($thirdOutOfThree >= 96 && $thirdOutOfThree <= 100) {
                                                                        $toutOfThree = '3.0';
                                                                    } else {
                                                                        $toutOfThree = 'N/A';
                                                                    }
                                                                @endphp
                                                                <div class="d-flex justify-content-between"> 
                                                                    <span>Third Term Average Score</span> 
                                                                    <span>-></span>
                                                                    <span class="text-muted fs-6 fw-bold mb-5">{{ $taverage }}</span>
                                                                </div>
                                                                <span class="separator separator-dashed mb-5"></span>
                                                                <div class="d-flex justify-content-between">
                                                                    <span>Cumulative Average Score</span>
                                                                    <span>-></span>
                                                                    <span class="text-muted fs-6 fw-bold">{{ $thirdAverage }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body p-3">
                                                        <div class="fw-bold fs-4">
                                                            <div class="d-flex">
                                                                ...
                                                                <!--end::Svg Icon-->
                                                                <div class="ms-2 "> Cumulative ( Out of 3 ) = <span class="text-muted fs-6 fw-bold">{{ $toutOfThree }}</span></div>
                                                            </div>
                                                            <div class="fs-7 fw-normal text-muted">The average score is calculated based on the total scores, and the <span class="fw-bold"> Out of 3 Scale</span> variable will hold the converted score on the "out of 3" scale</div>
                                                        </div>
                                                    </div>
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content shadow-none">
                        ...
                        <div class="mb-5 text-center">
                            ...
                            <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-circle symbol-fixed position-relative">
                                        <img src="{{ asset('storage/images/1687489148_School Logo.jpeg') }}" alt="image" />
                                    </div>
                                </div>
                            ...
                            <table class="table table-row-dashed align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="fw-bold text-muted bg-light">
                                        ...
                                        <th class="min-w-125px">Grade</th>
                                        <th class="min-w-125px">Out of 3</th>
                                        <th class="min-w-135px">Descriptors</t>
                                    </tr>
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light close_print" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-light-primary print_button" style="cursor:pointer">Print Results</button>
                    </div>
                </div>
            </div>
	    </div>
            ...
            <div class="modal fade" id="results_add_modal" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content rounded">
                        <!--begin::Modal header-->
                        <div class="modal-header pb-0 border-0 justify-content-end">
                            <!--begin::Close the icon used to close the results add modal-->
                            <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                <span class="svg-icon svg-icon-1">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <!--end::Close the icon used to close the results add modal-->
                        </div>
                        <!--begin::Modal header-->
                        <!--begin::Modal body-->
        ...
        <div class="modal fade" id="communication-modal" tabindex="-1" aria-labelledby="communication-modal-label" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="communication-modal-label"></h5>
        ...
        <!--begin::Modal - edit_student-->
            <div class="modal fade" id="edit_student_results" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <!--begin::Modal content-->
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form  id="teacher_form" enctype="multipart/form-data">
                                ...
                                <div class="mb-4 text-center">
                                    <!--begin::Title-->
                                    <h1 class="mb-3">Edit <span> {{$student->f_name}} </span> Results</h1>
                                    <!--end::Title-->
                                    <!--begin::Description-->
                                    <div class="text-muted fw-semibold fs-5 mb-5">A person who is studying at a university or other place of higher education</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Heading-->
                                <div class="p-9">
                                    <input type="hidden" value="{{$student->id}}" class="form-control" name="s_id" id="s_id" />
                                    <input type="hidden" value="" class="form-control" name="result_id" id="result_id" />
                                    <!--begin::Input group-->
                                    <div class="row mb-5">
                                        <div class="col-md-3 fv-row">
                                        </div>
                                        <div class="col-md-8 fv-row">
                                            <input type="text" value="" class="form-control" placeholder="Mutungo plot-123" name="s_mark" id="s_mark" />
                                            <span class="valid-feedback"></span>
                                            <span class="invalid-feedback">Oops! include the roll id!</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="separator mb-4"></div>
                                    <div class="d-flex justify-content-between mb-9" style="margin-left:15px;margin-right:20px;">
                                        <span class="btn btn-light-primary me-3">Cancel</span>
                                        <button type="submit" id="student_edit_result_submit" class="btn btn-light-primary">Edit</button>
                                    </div>
                                    <!--end::Actions-->
                                </div>	
                                <!--begin::Actions-->
        ...
        <!--begin::Modal - edit_student-->
            <div class="modal fade" id="edit_student_end_results" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <!--begin::Modal content-->
                    <div class="modal-content rounded">
                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form  id="teacher_form" enctype="multipart/form-data">
                                ...
                                <div class="p-9">
                                    <input type="hidden" value="{{$student->id}}" class="form-control" name="s_id" id="s_id" />
                                    <input type="hidden" value="" class="form-control" name="result_mark" id="result_mark" />
                                    <!--begin::Input group-->
                                    <div class="row mb-5">
                                        <div class="col-md-3 fv-row">
                                        </div>
                                        <div class="col-md-8 fv-row">
                                            <input type="text" value="" class="form-control" name="result_mark_id" id="result_mark_id" />
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Actions-->
                                    ...
                                    <div class="d-flex justify-content-between mb-9" style="margin-left:15px;margin-right:20px;">
                                        <span class="btn btn-light-primary me-3">Cancel</span>
                                        <button type="submit" id="student_edit_result_end_submit" class="btn btn-light-primary">Edit</button>
                                    </div>
                                    <!--end::Actions-->
                                </div>	
                                <!--begin::Actions-->
        ...
        <script>
            $(document).ready(function(){
                ...
                $('#print_firstterm_id').on('click', function(){
                    $('#first_term_results').modal('show');
                });
                ...
                $('.edit_single_results').on('click', function(){
                    var resultId = $(this).data('result-id');
                    var resultName = $(this).data('result-name');
                    $('#s_mark').val(resultName); 
                    $('#result_id').val(resultId);
                    
                     //alert(resultName);
                    $('#student_edit_result_submit').click(function() {
                        $("#student_edit_result_submit").prop('disabled',true);
                        $('#student_edit_result_submit').addClass('spinner spinner-white spinner-right').text('Editing ...');
                        $.ajax({
                            url: '/result_edit',
                            type: 'Post',
                            data: {
                    ...
                    $('#edit_student_results').modal('show');
                });



                $('.edit_single_end_results').on('click', function(){
                    var resultId = $(this).data('end-id');
                    var resultName = $(this).data('end-name');
                    $('#result_mark_id').val(resultName); 
                    $('#result_mark').val(resultId);
                    
                     //alert(resultName);
                    $('#student_edit_result_end_submit').click(function() {
                        $("#student_edit_result_end_submit").prop('disabled',true);
                        $('#student_edit_result_end_submit').addClass('spinner spinner-white spinner-right').text('Editing ...');
                        $.ajax({
                            url: '/result_end_edit',
                            type: 'Post',
                            data: {
                                s_id: $("#s_id").val(),
                                result_mark: $("#result_mark").val(),
                                result_mark_id: $("#result_mark_id").val(),
                                _token: '{{ csrf_token() }}'
                            },
                            success: function (response) {
                                console.log(response); 
                    ...
                    $('#edit_student_end_results').modal('show');
                });
				...
				//begin student_results 
                    ...
                    $('#results_form').on('submit', function(e) {
                        ...
                        $.ajax({
                            ...
                            data: formData,
                            success: function(response) {
                                alert('Student Results submitted successfully!');
								window.location.reload();
                            },
                            error: function(xhr) {
