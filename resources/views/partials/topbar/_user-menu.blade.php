...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
        ...
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="d-flex flex-column">
                <div class="fw-bolder d-flex align-items-center fs-5">
                    {{ auth()->user()->name }}
                    <span class="d-none badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Pro</span>
                </div>
    ...
    <!--begin::Menu item-->
    <div class="d-none menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
    ...
    <!--begin::Menu item-->
    <div class="d-none menu-item px-5" data-bs-toggle="tooltip" data-bs-placement="left" title="{{ __('Coming soon') }}">
        <a href="#" class="menu-link px-5">
            {{ __('My Statements') }}
        </a>
    </div>
    ...
    <div class="menu-item px-5">
        <a href="/logout" data-action="{{ theme()->getPageUrl('logout') }}" data-method="post" data-csrf="{{ csrf_token() }}" data-reload="true" class="button-ajax menu-link px-5">
            {{ __('Log Out') }}
        </a>
    </div>
    <!--end::Menu item-->
